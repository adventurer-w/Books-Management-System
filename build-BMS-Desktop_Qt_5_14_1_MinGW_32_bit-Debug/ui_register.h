...
public:
    ...
    void setupUi(QWidget *Register)
    {
        ...
        line_major = new QLineEdit(Register);
        line_major->setObjectName(QString::fromUtf8("line_major"));
        line_major->setGeometry(QRect(150, 260, 200, 30));
    ...
    void retranslateUi(QWidget *Register)
    {
        ...
        lb_major->setText(QCoreApplication::translate("Register", "\344\270\223\344\270\232", nullptr));
