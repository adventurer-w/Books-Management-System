...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        btn_login->setGeometry(QRect(40, 360, 180, 50));
        ...
        btn_register->setGeometry(QRect(270, 360, 180, 50));
        ...
        layoutWidget->setGeometry(QRect(130, 440, 240, 52));
        ...
        btn_wx = new QPushButton(layoutWidget);
        ...
        btn_qq = new QPushButton(layoutWidget);
        ...
        btn_wb = new QPushButton(layoutWidget);
