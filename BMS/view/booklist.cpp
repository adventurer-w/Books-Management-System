...
void BookList::loadBtnBooks(){
    ...
    int curNum = curRecord;
    int sum = re.size();
    int preRecord =curRecord;
    curRecord = sum <= curNum+ maxLoadNum ? sum:curNum+ maxLoadNum;
